...
const quo = document.querySelector("#quote span:first-child");
const ko = document.querySelector("#quote span:last-child");
const todayQuote = quotes[Math.floor(Math.random() * quotes.length)];

quo.innerText = todayQuote.quote;
ko.innerText = todayQuote.korean;